...
const Header = ({
  ...
  return (
    <header className="shadow-sm z-10 header-container">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Menu as="div" className="relative">
              ...
              >
                <Menu.Items className="header-profile-menu absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md shadow-lg focus:outline-none">
